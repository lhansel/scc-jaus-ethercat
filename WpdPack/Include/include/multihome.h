...
/******************************************************************************
 *
 * Copyright 2002-2004 NetBurner  ALL RIGHTS RESERVED
...
/* Definitions for various multi home IP definitions and structures. */
#ifndef _NB_MULTI_IP_H
#define _NB_MULTI_IP_H

#ifndef NUM_MULTI_INTERFACES 
#define NUM_MULTI_INTERFACES (10)
#endif

extern int nAdditional_Homes;
extern int multi_home_if_record[NUM_MULTI_INTERFACES];
